...
const ThirdSession = () => {
  const alignbot = "mt-[60px]";
  return (
    <div id="second-session" className="pb-[80px] pt-[70px] flex justify-center">
      <div className="container flex justify-center max-w-[1230px] flex-wrap">
        <div className="flex justify-center w-[100%]">
          <div className="columns-8 flex justify-center">
            <div className="mb-[80px] text-center">
              <h2 className="xl:w-[600px] xl:text-7xl lg:text-6xl md:text-6xl sm:text-46xl text-6xl font-PowerGrotesk font-bold">
                Why choose us?
              </h2>
            </div>
          </div>
        ...
        <div className="flex justify-center">
          <div className="flex flex-wrap justify-center gap-8 pt-[60px]">
            <ThirdCard
              number="01."
              title={
                <span>
